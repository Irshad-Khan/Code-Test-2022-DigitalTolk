...
use App\Http\Traits\ThrottleTrait;
use App\Http\Traits\TimeConversionTrait;
...
{
    use TimeConversionTrait, ThrottleTrait, NotificationTrait;
     ...
     * @param Job $model
     */
    function __construct(Job $model, MailerInterface $mailer, JobRepository $jobRepository)
    {
    ...
    {
        return $this->jobRepository->getUsersJobs($user_id);
    }
    ...
    {
        return $this->getPotentialJobIdsWithUserId($user_id);
    }
    ...
    {
        $this->jobRepository->updateJob($id, $data, $cuser);
    }
    ...
    {
        return $this->sendChangeDateNotification($job, $current_translator, $new_translator);
    }
    ...
    {
        return $this->sendChangeDateNotification($job, $old_time);
    }
    ...
    {
        return $this->sendChangedLanguageNotification($job, $old_lang);
    }
    ...
    {
        return $this->sendExpiredJobNotification($job, $user);
    }
    ...
    {
        return $this->sendNotificationsByAdminCancelJob($job_id);
    }
    ...
    {
        return $this->sendNotificationChangePendingStatus($user, $job, $language, $due, $duration);
    }
    ...
    {
        return $this->jobRepository->acceptJobWithId($job_id, $cuser);
    }

    /**
     * Cancel Job request sending from ajax
     *
     * @param [type] $data
     * @param [type] $user
     * @return void
    ...
    {
        return $this->jobRepository->getPotentialJobIdsWithUserId($user_id);
    }
    ...
    {
        return $this->jobRepository->endJob($post_data);
    }
    ...
    {
        return $this->jobRepository->ignoreNearToExpiring($id);
    }
    ...
    {
        return $this->jobRepository->ignoreExpired($id);
    }
    ...
    {
        return $this->ignoreThrottleRequest($id);
    }
    ...
    {
        return $this->convertTimeToHoursMins($time, $format);
    }
}